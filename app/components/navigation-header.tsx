...
// Updated resume link with sharing URL
const RESUME_LINKS = {
  primary: "https://drive.google.com/file/d/15kl4qW_Q_61jKKSr2MvdBv9Eqk8zbA9d/view?usp=sharing",
...
export default function NavigationHeader() {
  ...
  const handleResumeClick = () => {
    ...
    window.open(RESUME_LINKS.primary, "_blank", "noopener,noreferrer")
  }
