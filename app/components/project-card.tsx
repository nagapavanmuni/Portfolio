...
=======
        <div className="absolute inset-0 bg-gradient-to-br from-teal-500/5 via-transparent to-blue-500/5 opacity-0 group-hover:opacity-100 transition-all duration-700" />
>>>>>>> f85d32de63cf560b3a18dcf7cd069e6b9af11838
...
=======
                className="flex items-center gap-2 px-3 py-2 bg-teal-600/95 hover:bg-teal-600 rounded-lg text-sm font-medium text-white transition-all duration-300 hover:scale-110 shadow-lg backdrop-blur-sm"
>>>>>>> f85d32de63cf560b3a18dcf7cd069e6b9af11838
              >
...
=======
        <div className="absolute top-0 right-0 w-16 h-16 bg-gradient-to-bl from-teal-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700" />
>>>>>>> f85d32de63cf560b3a18dcf7cd069e6b9af11838
      </div>
